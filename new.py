...
with col1:
    ...
    R12 = st.number_input("R12:ohms", min_value=0.0, step=0.01)
    R23 = st.number_input("R23:ohms", min_value=0.0, step=0.01)
    R31 = st.number_input("R31:ohms", min_value=0.0, step=0.01)
